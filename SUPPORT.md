...
Hello, thank you for using Unite! 🙋🏻‍♂️
...
- Check the [`README`](https://github.com/igorskyflyer/npm-unite/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-unite/issues) to see if your question has already been answered.
...
- open a [`new issue`](https://github.com/igorskyflyer/npm-unite/issues) using the appropriate issue template and with the label of `bug`,
...
- opening a [`new issue`](https://github.com/igorskyflyer/npm-unite/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-unite/blob/main/CONTRIBUTING.md) for guidelines.
...
If you'd like to support further development of Unite:
